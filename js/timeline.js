(function(global, d3, _) {
  ...
  global.timeline = function() {
    ...
    function renderSketch(svg) {
      ...
      // sketch = container
      //   .selectAll('.series.touch')
      //   .data([path]);
      // sketch.exit().remove();
      // sketch = sketch
      //   .enter()
      //   .append('path')
      //     .attr('class', 'series touch')
      //     .attr('fill', 'none')
      //     .attr('stroke', 'red')
      //     .attr('stroke-width', 20)
      //     .attr('stroke-linecap', 'round')
      //     .attr('opacity', .00001)
      //     .each(_.partial(initSketchTouch, svg))
      //   .merge(sketch)
      //     .attr('d', d => d);
    }
    ...
    function renderPoints(svg) {
      ...
      point = point
        ...
        .merge(point)
          ...
          .attr('stroke', d => d.type ? 'none' : 'black')
          .attr('stroke-width', 2)
          .attr('fill', d => d.type ? 'black' : 'none');
    }
